...
namespace PlayerManager4
{
    public class Player: IComparable<Player>
    {
        ...
        //Recebe Lista tipo IEnumerable e ordena por ordem de maior para menor
    ...
    public class CompareByName : IComparer<Player>
    {
        ...
        //Recebe valor de booleano para distiguir se ascende ou descende
        public CompareByName(bool ascend = false){
            _ascend = ascend;
        }
        //Compara duas lista com ascensão defenida anteriormente
    ...
    public class Program
    {
            ...
            do
            {
                ...
                switch (option)
                {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        ListPlayerNameAscend(playerList);
                        break;
                    case "5":
                        ListPlayerNameDescend(playerList);
                        break;
                    case "6":
        ...
        private void ShowMenu()
        {
            ...
            Console.WriteLine("4. List players by name ascended");
            Console.WriteLine("5. List players by name descended");
        ...
        private static void ListPlayers(IEnumerable<Player> playersToList)
        {
            ...
            //cria uma nova lista que vai buscar o "CompareTo" da classe Player para ordenar a lista que recebe
            List<Player> myList = new List<Player>(playersToList);
        ...
        private static void ListPlayerNameAscend(IEnumerable<Player> playersToList)
        {
            Console.WriteLine("\nList of players");
            Console.WriteLine("-------------\n");
            ...
            //cria um comparador que ascende uma lista
            CompareByName comparer = new CompareByName(true);
        ...
        private static void ListPlayerNameDescend(IEnumerable<Player> playersToList)
        {
            Console.WriteLine("\nList of players");
            Console.WriteLine("-------------\n");
            ...
            //cria um comparador que descende uma lista
            CompareByName comparer = new CompareByName(false);
